...
build: (cache-kernel-version) (fetch-kernel)
    ...
    LABELS=(
        ...
        "--label" "io.artifacthub.package.keywords=bootc,fedora,rouge"
        "--label" "io.artifacthub.package.maintainers=[{\"name\": \"rougeos\", \"email\": \"hello@rougeos.com\"}]"
        "--label" "io.artifacthub.package.readme-url=https://raw.githubusercontent.com/rougeos/rouge-akmods/refs/heads/main/README.md"
        ...
        "--label" "org.opencontainers.image.source=https://raw.githubusercontent.com/rougeos/rouge-akmods/refs/heads/main/Containerfile.in"
...
manifest:
    ...
    LABELS=(
        ...
        "io.artifacthub.package.readme-url=https://raw.githubusercontent.com/rougeos/rouge-akmods/refs/heads/main/README.md"
        "org.opencontainers.image.created={{ datetime_utc('%Y-%m-%dT%H:%M:%SZ') }}"
        "org.opencontainers.image.description={{ _description }}"
        "org.opencontainers.image.license=Apache-2.0"
        "org.opencontainers.image.source=https://raw.githubusercontent.com/rougeos/rouge-akmods/refs/heads/main/Containerfile.in"
